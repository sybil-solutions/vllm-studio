...
**Verify after build:** start a turn → switch to another chat → backgrounded session shows a spinner in its sidebar row; when it finishes → unseen dot; opening it clears the dot.
