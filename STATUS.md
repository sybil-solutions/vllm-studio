...
- [x] Inspect session type comments.
- [x] Remove redundant session type field comments.
- [x] Validate frontend session type comment cleanup slice.
- [x] Commit this slice.
