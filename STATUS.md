...
- [x] Inspect session-map helper comments.
- [x] Remove redundant session store/selectors comments.
- [x] Validate frontend session comment cleanup slice.
- [x] Commit this slice.
