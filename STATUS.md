...
- [x] Inspect tools context comments.
- [x] Remove redundant tools context member comments.
- [x] Validate frontend tools context comment cleanup slice.
- [x] Commit this slice.
